(function () {
    ...
    <section class="screen-section">
        ...
        const JGASection = ` <section class="screencapture-section">
        <div class="container">
                <div class="heading">
...
`;
        ...
        function changesWithOutData() {
            // Change heading text
            waitForElement('.homepage .hero h1', function () {
                document.querySelector('.homepage .hero h1').innerHTML = 'Plane deinen JGA';
            });

            let Sections = featuresSection + JGASection + FaqSection;
            // Adding rating above the heading----
            waitForElement('.homepage .hero h1', function () {
                document.querySelector('.homepage .hero ').insertAdjacentHTML('beforebegin', ratingElement);
            });

            // Adding screen section after hero section
            waitForElement('.hero', function () {
                document.querySelector('.hero').insertAdjacentHTML('afterend', Sections);
                // accordion section js work
...
document.querySelector('.sidebar').insertAdjacentHTML('beforebegin',slidebarsection);
        ...
        function init() {
            ...
            if (main.getAttribute('data-itinerary-sync')) {
                // Data fill code
                changesWithData()
            } else {
                // Without data fill code
                changesWithOutData();
            }
        }
        /* Initialize variation */
        waitForElement("body main", init);
    } catch (e) {
